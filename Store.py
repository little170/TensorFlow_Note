...
sub_saver = tf.train.Saver({'Weight1':w1,'Weight2':w2,'Bias1':b1,'Bias2':b2})
...
with tf.Session() as sess:
    ...
    sub_save_path = sub_saver.save(sess,'/tmp/sub_model/model.ckpt')   
    # Test model
    # Calculate accuracy
...
print("Sub-model Save Path=",sub_save_path)
